...
then
	...
	bash <(curl -s https://codecov.workiva.net/bash) -u https://codecov.workiva.net -r $TRACKING_REMOTE -f coverage/coverage.lcov || echo "ERROR: Codecov failed to upload reports."
fi